...
scatter.smooth(cohort$cohort_mean~cohort$year,lpars = list(col = "red", lwd = 3, lty = 3), main= "US Income Mobilty by Year", xlab = "Cohort Year", ylab = "Mean Income Mobility")
...
abline(lm(data$RATE~data$Mobility),col="RED")
```
...
abline(lm(data$Happiness~data$Mobility),col="RED")
